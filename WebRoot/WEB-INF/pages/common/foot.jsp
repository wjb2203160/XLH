...
<%@ page language="java" import="java.util.*" pageEncoding="UTF-8"%>
		...
		<footer>
			<p class="pull-left">&copy; <a href="http://usman.it" target="_blank">薪立核</a> 2017</p>
			<p class="pull-right">Powered by: <a href="http://usman.it/free-responsive-admin-template">lingd</a></p>
		</footer>
	...
	<!-- add by lingd 2017-11-27 start multiple file ajaxfileupload plugin-->
	<script src="statics/js/ajaxfileupload.js"></script>
	<!-- add by lingd 2017-11-27 end-->
	<!-- add by lingd 2017-11-27 start WdatePicker plugin-->
    ...
    <script src="statics/localjs/distpicker.data.js"></script>
    <script src="statics/localjs/distpicker.js"></script>
